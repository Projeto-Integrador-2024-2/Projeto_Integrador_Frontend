...
const ProjectBlockGrade = ({ id, name, imageUrl, isPrivate, accessToken, averageGrade }) => {
  const blockClass = isPrivate ? "block private" : "block";

  const handleDeleteGrade = async () => {
    if (window.confirm("Tem certeza de que deseja excluir sua avaliação deste projeto?")) {
      try {
        ...
        alert("Ocorreu um erro ao tentar excluir a avaliação.");
      }
    }
  };
...
export { ProjectBlock, ProjectBlock2, ProjectBlock3, ProjectBlockGrade };